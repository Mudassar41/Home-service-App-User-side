...
import 'package:user_side/services/phoneAuthService.dart';
...
import 'package:user_side/utils/verificationCodeFields.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  SharePrefService sharedPrefService = SharePrefService();
  bool value = true;
  ...
  UserProfile providerModel = UserProfile();
                                      ...
                                      if (passwordController.text ==
                                        ...
                                        if (!formKey3.currentState.validate()) {
                                          ...
                                          providerModel.phoneNumber =
                                              '${countryCode}${phoneNumberController.text}';
                                          // print(providerModel.phoneNumber='${countryCode}${phoneNumberController.text}');
                                          // providerModel.authId = FirebaseAuth
                                          //     .instance.currentUser.uid;
                                          //print(providerModel.authId);
